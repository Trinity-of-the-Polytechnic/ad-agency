...
update Tasks_Task as t
    ...
    returning t.id, t.project, t.description, t.status;

select t.id, t.project, t.description, t.deadline, s.name
    from Tasks_Task as t join Tasks_Status as s on(t.status = s.id);
